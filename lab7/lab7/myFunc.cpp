...
int main()
{
	...
	for (;;)
	{
		...
		cout << "7 - Подсчёт количества элементов стека, у которых равные соседи" << endl;
		cout << "0 - Выход" << endl;
		...
		case 7:
			cout << "Количество элементов стека, у которых равные соседи: ";
			counterEqualLeftAndRight(myStk);
			break;
